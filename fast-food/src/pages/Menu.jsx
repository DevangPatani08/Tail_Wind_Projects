    ...
    <section className='w-full flex flex-col items-center justify-start box-border px-6 md:px-10'>
      <div className="w-full max-w-[90rem] pt-24 flex flex-col items-center justify-start box-border">
        ...
        <div className='w-full flex flex-col items-center justify-start box-border mb-10'>
          <CustomStyle variant='h2' className='w-full text-[var(--color-n)] text-center mb-2'>Our <span className='text-[var(--color-s)]'>Menu</span></CustomStyle>
          <CustomStyle variant='p_m' className='w-full text-center text-[var(--color-n-m)]'>Discover delicious meals from every category</CustomStyle>
        </div>
        
        {/* Categories Navigation */}
        <div ref={navRef} className='w-full flex flex-wrap items-center justify-center gap-2 mb-8 lg:mb-12'>
          {categories.map((c) => (
            <CustomStyle key={c.strCategory} variant='p_m' className='text-center w-fit text-[var(--color-n)]'>
              <button
                type='button'
